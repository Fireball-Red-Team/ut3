...
# Generated by trane/deploy-ut3-cp01.sh — re-run the script to update.
[Unit]
...
QUADLET
  ...
  log "[2/5] Endpoint installed (systemd unit: embernet.service)."
}
